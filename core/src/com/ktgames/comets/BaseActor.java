...
// 6.26.2020 adjust BaseActor to extend Group (vs. Actor) so Actor effects
// (e.g. spaceship thrusters and shield) can be added
public class BaseActor extends Group
{
    ...
    public void wrapAroundWorld()
    {
        ...
        {
            this.setX(this.worldBounds.width);
        }

        // -this.getWidth will send object to opposite side of the world
        if (this.getX() > this.worldBounds.width)
        {
        ...
        {
            this.setY(this.worldBounds.height);
        }

        if (this.getY() > this.worldBounds.height)
        {
    ...
    public void draw(Batch batch, float parentAlpha)
    {
        ...
        // 6.26.2020 - updating parent method call to after code above (vs. before) so that the actors
        // attached to the group render after (and therefore, appear on top of) the image corresponding to the group
        // object itself.
